package yt.com.lsmlibrary.loader;
...
import yt.com.lsmlibrary.attr.SkinItem;
import yt.com.lsmlibrary.attr.base.AttrFactory;
import yt.com.lsmlibrary.attr.base.DynamicAttr;
import yt.com.lsmlibrary.attr.base.SkinAttr;
import yt.com.lsmlibrary.common.SkinConfig;
import yt.com.lsmlibrary.utils.SkinListUtils;
...
public class SkinInflaterFactory implements LayoutInflater.Factory2 {
    ...
    private void parseSkinAttr(Context context, AttributeSet attrs, View view) {
        ...
        LogUtils.iTag(TAG, "viewName:" + view.getClass().getSimpleName());
        for (int i = 0; i < attrs.getAttributeCount(); i++) {
            String attrName = attrs.getAttributeName(i);
            String attrValue = attrs.getAttributeValue(i);
            LogUtils.iTag(TAG, "    AttributeName:" + attrName + "|attrValue:" + attrValue);
            //region  style
            //style theme
            if ("style".equals(attrName)) {
                ...
                if (textColorId != -1) {
                    ...
                    LogUtils.iTag(TAG, "    textColor in style is supported:" + "\n" +
                ...
                if (backgroundId != -1) {
                    ...
                    LogUtils.iTag(TAG, "    background in style is supported:" + "\n" +
            ...
            if (AttrFactory.isSupportedAttr(attrName) && attrValue.startsWith("@")) {
                try {
                    ...
                    LogUtils.iTag(TAG, "    " + attrName + " is supported:" + "\n" +
                            "    resource id:" + id + "\n" +
                            "    attrName:" + attrName + "\n" +
                            "    attrValue:" + attrValue + "\n" +
                            "    entryName:" + entryName + "\n" +
    ...
    public void removeSkinView(View view) {
        LogUtils.iTag(TAG, "removeSkinView:" + view);
        SkinItem skinItem = mSkinItemMap.remove(view);
        if (skinItem != null) {
            LogUtils.iTag(TAG, "removeSkinView from mSkinItemMap:" + skinItem.view);
        }
        if (SkinConfig.isCanChangeFont() && view instanceof TextView) {
            LogUtils.iTag(TAG, "removeSkinView from TextViewRepository:" + view);
